...
<html lang="en-gb" dir="ltr">
 ...
 String heading = request.getParameter("eheading");
        ...
        <div>
          <div class="uk-card">
            <div class="uk-container uk-container-large uk-padding-large">
              ...
              >
                <h1 class="uk-text-center uk-text-bolder">Update FAQ</h1>
                <div class="uk-article-content">
                  <form
                    action="UpdateFAQS" method="post"
                  ...
                  <!--input text-->
                    ...
                    <!--textArea-->
                    <div class="uk-margin-bottom">
                      <label class="uk-form-label" for="message">Content</label>
                      <div class="uk-form-controls">
                        <textarea
                          id="message"
        ...
        <div>
          <div class="uk-card uk-background-default">
            <div class="uk-position-center uk-position-relative">
              <img width="550px" src="img/faqUpdate.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
