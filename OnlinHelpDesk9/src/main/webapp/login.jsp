            ...
            <div class="uk-container uk-container-large uk-padding-large">
                ...
                >
                    ...
                    <div class="uk-article-content">
                        <form
                                class="uk-form-stacked uk-margin-medium-top uk-margin-medium-bottom" action="login"
                                method="post"
                        >
                            ...
                            <br/>
                            <div class="uk-margin-bottom">
                                <a class="uk-link-muted" href="register.jsp"
                                >not a member please register here</a
                                >
                            </div>
